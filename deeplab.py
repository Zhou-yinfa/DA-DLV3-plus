...
class DeeplabV3(object):
    _defaults = {
        ...
        #----------------------------------------#
        #   DA-DLV3+ 注意力模块设置（必须与训练时保持一致！）
        #
        #   ASPP后注意力（二选一）:
        #     use_dapsa  → DAPSA 方向感知极化自注意力（推荐）
        #     use_cbam   → CBAM 通道+空间注意力
        #
        #   浅层注意力:
        #     use_ca     → 浅层CA坐标注意力
        #
    ...
    def generate(self, onnx=False):
        ...
        self.net = DeepLab(num_classes=self.num_classes, backbone=self.backbone,
                           ...
                           use_dapsa=self.use_dapsa, use_cbam=self.use_cbam, use_ca=self.use_ca)
